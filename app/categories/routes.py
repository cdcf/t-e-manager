...
def edit_category(id):
    ...
    pagination = Category.query.order_by(Category.name.desc()).paginate(page, 5, False)
    categories = pagination.items
    return render_template('settings/edit_category.html', title='Edit Category', form=form, categories=categories,
                           pagination=pagination)
...
def delete_category(id):
    ...
    return redirect(url_for('categories.edit_category'))
